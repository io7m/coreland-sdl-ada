...
package SDL.rwops is
  ...
  function RWFromFP (file: stdio_file_t; autoclose: c.int) return rwops_ptr_t;
  function rw_From_fp (file: stdio_file_t; autoclose: c.int) return rwops_ptr_t renames RWFromFP;
