...
package SDL.audio is
  ...
  type audio_cvt_filter_t is
    access procedure (cvt : void_ptr_t; format : audio_format_t);
  ...
  function load_wav
   (file      : cs.chars_ptr;
    spec      : audio_spec_ptr_t;
    audio_buf : access uint8_ptr;
    len       : access uint32) return audio_spec_ptr_t renames LoadWAV;
  function load_wav
   (file      : cs.chars_ptr;
    spec      : audio_spec_t;
    audio_buf : access uint8_ptr;
  ...
  function LoadWAV
   (file       : string;
    spec       : audio_spec_t;
    audio_buf  : access uint8_ptr;
    len        : access uint32) return audio_spec_ptr_t renames load_wav;
  ...
  function OpenAudio
   (desired  : audio_spec_t;
    obtained : audio_spec_ptr_t) return c.int;
  function open_audio
   (desired  : audio_spec_t;
    obtained : audio_spec_ptr_t) return c.int renames OpenAudio;
  ...
  function open_audio
   (desired  : audio_spec_t;
    obtained : audio_spec_ptr_t) return boolean renames OpenAudio;
