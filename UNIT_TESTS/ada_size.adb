...
procedure ada_size is
  ...
  sdl_audio_cvt_ptr_t : aliased string := "sdl.audio.cvt_ptr_t";
  sdl_audio_cvt_t : aliased string := "sdl.audio.cvt_t";
  sdl_audio_spec_ptr_t : aliased string := "sdl.audio.spec_ptr_t";
  ...
  sdl_events_active_event_ptr_t : aliased string := "sdl.events.active_event_ptr_t";
  sdl_events_active_event_t : aliased string := "sdl.events.active_event_t";
  sdl_events_event_ptr_t : aliased string := "sdl.events.event_ptr_t";
  sdl_events_event_t : aliased string := "sdl.events.event_t";
  sdl_events_filter_t : aliased string := "sdl.events.filter_t";
  sdl_events_joy_axis_event_ptr_t : aliased string := "sdl.events.joy_axis_event_ptr_t";
  sdl_events_joy_axis_event_t : aliased string := "sdl.events.joy_axis_event_t";
  sdl_events_joy_ball_event_ptr_t : aliased string := "sdl.events.joy_ball_event_ptr_t";
  sdl_events_joy_ball_event_t : aliased string := "sdl.events.joy_ball_event_t";
  sdl_events_joy_button_event_ptr_t : aliased string := "sdl.events.joy_button_event_ptr_t";
  sdl_events_joy_button_event_t : aliased string := "sdl.events.joy_button_event_t";
  sdl_events_joy_hat_event_ptr_t : aliased string := "sdl.events.joy_hat_event_ptr_t";
  sdl_events_joy_hat_event_t : aliased string := "sdl.events.joy_hat_event_t";
  sdl_events_keyboard_event_ptr_t : aliased string := "sdl.events.keyboard_event_ptr_t";
  sdl_events_keyboard_event_t : aliased string := "sdl.events.keyboard_event_t";
  sdl_events_mask_t : aliased string := "sdl.events.mask_t";
  sdl_events_mouse_button_event_ptr_t : aliased string := "sdl.events.mouse_button_event_ptr_t";
  sdl_events_mouse_button_event_t : aliased string := "sdl.events.mouse_button_event_t";
  sdl_events_mouse_motion_event_ptr_t : aliased string := "sdl.events.mouse_motion_event_ptr_t";
  sdl_events_mouse_motion_event_t : aliased string := "sdl.events.mouse_motion_event_t";
  sdl_events_quit_event_ptr_t : aliased string := "sdl.events.quit_event_ptr_t";
  sdl_events_quit_event_t : aliased string := "sdl.events.quit_event_t";
  sdl_events_resize_event_ptr_t : aliased string := "sdl.events.resize_event_ptr_t";
  sdl_events_resize_event_t : aliased string := "sdl.events.resize_event_t";
  sdl_events_sys_wm_event_ptr_t : aliased string := "sdl.events.sys_wm_event_ptr_t";
  sdl_events_sys_wm_event_t : aliased string := "sdl.events.sys_wm_event_t";
  sdl_events_sys_wm_msg_ptr_t : aliased string := "sdl.events.sys_wm_msg_ptr_t";
  sdl_events_type_t : aliased string := "sdl.events.type_t";
  sdl_events_user_event_ptr_t : aliased string := "sdl.events.user_event_ptr_t";
  sdl_events_user_event_t : aliased string := "sdl.events.user_event_t";
  sdl_joystick_joystick_ptr_t : aliased string := "sdl.joystick.joystick_ptr_t";
  sdl_keyboard_keysym_const_ptr_t : aliased string := "sdl.keyboard.keysym_const_ptr_t";
  sdl_keyboard_keysym_ptr_t : aliased string := "sdl.keyboard.keysym_ptr_t";
  ...
  sdl_mouse_cursor_ptr_t : aliased string := "sdl.mouse.cursor_ptr_t";
  ...
  sdl_video_color_ptr_t : aliased string := "sdl.video.color_ptr_t";
  sdl_video_color_t : aliased string := "sdl.video.color_t";
  sdl_video_palette_ptr_t : aliased string := "sdl.video.palette_ptr_t";
  sdl_video_palette_t : aliased string := "sdl.video.palette_t";
  sdl_video_pixel_format_ptr_t : aliased string := "sdl.video.pixel_format_ptr_t";
  sdl_video_pixel_format_t : aliased string := "sdl.video.pixel_format_t";
  sdl_video_rect_ptr_t : aliased string := "sdl.video.rect_ptr_t";
  sdl_video_rect_t : aliased string := "sdl.video.rect_t";
  sdl_video_surface_ptr_t : aliased string := "sdl.video.surface_ptr_t";
  sdl_video_surface_t : aliased string := "sdl.video.surface_t";
  sdl_video_video_info_ptr_t : aliased string := "sdl.video.video_info_ptr_t";
  ...
  types : aliased constant type_lookup_t := (
    (sdl_audio_cvt_ptr_t'access, sdl.audio.cvt_ptr_t'size),
    (sdl_audio_cvt_t'access, sdl.audio.cvt_t'size),
    (sdl_audio_spec_ptr_t'access, sdl.audio.spec_ptr_t'size),
    ...
    (sdl_events_active_event_ptr_t'access, sdl.events.active_event_ptr_t'size),
    (sdl_events_active_event_t'access, sdl.events.active_event_t'size),
    (sdl_events_event_ptr_t'access, sdl.events.event_ptr_t'size),
    (sdl_events_event_t'access, sdl.events.event_t'size),
    (sdl_events_filter_t'access, sdl.events.filter_t'size),
    (sdl_events_joy_axis_event_ptr_t'access, sdl.events.joy_axis_event_ptr_t'size),
    (sdl_events_joy_axis_event_t'access, sdl.events.joy_axis_event_t'size),
    (sdl_events_joy_ball_event_ptr_t'access, sdl.events.joy_ball_event_ptr_t'size),
    (sdl_events_joy_ball_event_t'access, sdl.events.joy_ball_event_t'size),
    (sdl_events_joy_button_event_ptr_t'access, sdl.events.joy_button_event_ptr_t'size),
    (sdl_events_joy_button_event_t'access, sdl.events.joy_button_event_t'size),
    (sdl_events_joy_hat_event_ptr_t'access, sdl.events.joy_hat_event_ptr_t'size),
    (sdl_events_joy_hat_event_t'access, sdl.events.joy_hat_event_t'size),
    (sdl_events_keyboard_event_ptr_t'access, sdl.events.keyboard_event_ptr_t'size),
    (sdl_events_keyboard_event_t'access, sdl.events.keyboard_event_t'size),
    (sdl_events_mask_t'access, sdl.events.mask_t'size),
    (sdl_events_mouse_button_event_ptr_t'access, sdl.events.mouse_button_event_ptr_t'size),
    (sdl_events_mouse_button_event_t'access, sdl.events.mouse_button_event_t'size),
    (sdl_events_mouse_motion_event_ptr_t'access, sdl.events.mouse_motion_event_ptr_t'size),
    (sdl_events_mouse_motion_event_t'access, sdl.events.mouse_motion_event_t'size),
    (sdl_events_quit_event_ptr_t'access, sdl.events.quit_event_ptr_t'size),
    (sdl_events_quit_event_t'access, sdl.events.quit_event_t'size),
    (sdl_events_resize_event_ptr_t'access, sdl.events.resize_event_ptr_t'size),
    (sdl_events_resize_event_t'access, sdl.events.resize_event_t'size),
    (sdl_events_sys_wm_event_ptr_t'access, sdl.events.sys_wm_event_ptr_t'size),
    (sdl_events_sys_wm_event_t'access, sdl.events.sys_wm_event_t'size),
    (sdl_events_sys_wm_msg_ptr_t'access, sdl.events.sys_wm_msg_ptr_t'size),
    (sdl_events_type_t'access, sdl.events.type_t'size),
    (sdl_events_user_event_ptr_t'access, sdl.events.user_event_ptr_t'size),
    (sdl_events_user_event_t'access, sdl.events.user_event_t'size),
    (sdl_joystick_joystick_ptr_t'access, sdl.joystick.joystick_ptr_t'size),
    (sdl_keyboard_keysym_const_ptr_t'access, sdl.keyboard.keysym_const_ptr_t'size),
    (sdl_keyboard_keysym_ptr_t'access, sdl.keyboard.keysym_ptr_t'size),
    ...
    (sdl_mouse_cursor_ptr_t'access, sdl.mouse.cursor_ptr_t'size),
    ...
    (sdl_video_color_ptr_t'access, sdl.video.color_ptr_t'size),
    (sdl_video_color_t'access, sdl.video.color_t'size),
    (sdl_video_palette_ptr_t'access, sdl.video.palette_ptr_t'size),
    (sdl_video_palette_t'access, sdl.video.palette_t'size),
    (sdl_video_pixel_format_ptr_t'access, sdl.video.pixel_format_ptr_t'size),
    (sdl_video_pixel_format_t'access, sdl.video.pixel_format_t'size),
    (sdl_video_rect_ptr_t'access, sdl.video.rect_ptr_t'size),
    (sdl_video_rect_t'access, sdl.video.rect_t'size),
    (sdl_video_surface_ptr_t'access, sdl.video.surface_ptr_t'size),
    (sdl_video_surface_t'access, sdl.video.surface_t'size),
    (sdl_video_video_info_ptr_t'access, sdl.video.video_info_ptr_t'size),
